...
const PolicyAuditProPage: React.FC = () => {
    ...
    return (
        <>
            <Meta
                title="Policy Audit Pro - Compliance Automation Tool | CyberGaar"
                description="Streamline your compliance process with Policy Audit Pro, the ultimate automation tool for evidence collection, management, and reporting for standards like ISO 27001 and PCI DSS."
            />
            <div className="-mt-32 bg-black text-white">
                <section className="hero-section text-center py-20 px-4 bg-slate-900 text-white" style={{ backgroundColor: '#0f172a', color: 'white', marginTop: '125px' }}>
                    <AnimatedSection>
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                            <a href="http://demo.cybergaar.com/" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white font-bold py-3 px-6 rounded-full text-md transition-transform hover:scale-105 w-full sm:w-auto flex items-center justify-center">
                                <PlayIcon className="w-5 h-5 mr-2" />
                                Go To Demo
                            </a>
                            <a href="https://github.com/OmerRastgar/AI-Audit-Analyzer" target="_blank" rel="noopener noreferrer" className="border-2 border-white/20 text-gray-300 font-bold py-3 px-6 rounded-full text-md transition-transform hover:scale-105 hover:bg-white/10 hover:text-white w-full sm:w-auto flex items-center justify-center">
                ...
                <div className="container mx-auto py-20 px-4">
                    <AnimatedSection className="mb-20">
                        <h2 className="text-3xl font-bold text-center text-gray-100 mb-8">Introducing Our Product</h2>
                        <div className="aspect-w-16 aspect-h-9 max-w-4xl mx-auto bg-gray-800/50 backdrop-blur-sm rounded-lg shadow-lg overflow-hidden cursor-pointer border border-white/10" onClick={openModal}>
                            <img src="/images/product-demo-thumbnail.jpg" alt="Product demo video thumbnail" className="w-full h-full object-cover" width="800" height="450" />
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
                        {features.map((feature, index) => (
                            <AnimatedSection key={index} className={`delay-${index * 100}`}>
                                <div className="text-center bg-gray-800/50 backdrop-blur-sm p-8 rounded-lg shadow-md hover:shadow-xl hover:-translate-y-2 transition-all duration-300 h-full flex flex-col border border-white/10 hover:border-blue-400">
                                    <div className="mb-4 text-blue-400 mx-auto">
