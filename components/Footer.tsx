                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="flex space-x-4 mt-4">
                            ...
                            <a href="https://x.com/CyberGaar_" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link to="/compliance-audit" className="text-slate-400 hover:text-white transition-colors">Compliance Audit</Link></li>
                            <li><Link to="/security-testing" className="text-slate-400 hover:text-white transition-colors">Security Testing</Link></li>
                            <li><Link to="/vulnerability-assessment" className="text-slate-400 hover:text-white transition-colors">Vulnerability Assessment</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link to="/virtual-browser" className="text-slate-400 hover:text-white transition-colors">Virtual Browser</Link></li>
