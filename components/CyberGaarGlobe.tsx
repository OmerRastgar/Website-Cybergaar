...
const CyberGaarGlobe: React.FC<CyberGaarGlobeProps> = ({ onBannerHiddenChange }) => {
  ...
  const countryData = useMemo(() => {
    const rawData = [
      { name: 'United States', lat: [24, 50], lon: [-125, -66], standards: ['NIST', 'SOC 2', 'HIPAA'] },
      { name: 'Canada', lat: [50, 70], lon: [-130, -60], standards: ['PIPEDA', 'ISO27001'] },
      { name: 'Mexico', lat: [14, 32], lon: [-118, -86], standards: ['LFPDPPP', 'ISO27001'] },
      { name: 'Brazil', lat: [-30, -5], lon: [-70, -40], standards: ['LGPD', 'ISO27001'] },
      { name: 'Argentina', lat: [-50, -25], lon: [-70, -60], standards: ['PDPA', 'ISO27001'] },
      { name: 'United Kingdom', lat: [50, 58], lon: [-8, 2], standards: ['CyberEss', 'GDPR', 'PCI'] },
      { name: 'France', lat: [42, 51], lon: [-5, 8], standards: ['LPM', 'GDPR'] },
      { name: 'Germany', lat: [47, 55], lon: [6, 15], standards: ['BSI', 'GDPR'] },
      { name: 'Spain', lat: [36, 43], lon: [-8, 2], standards: ['ENS', 'GDPR'] },
      { name: 'Italy', lat: [38, 46], lon: [8, 16], standards: ['ISO27001', 'GDPR'] },
      { name: 'Netherlands', lat: [51, 53], lon: [4, 7], standards: ['BIO', 'GDPR'] },
      { name: 'Sweden', lat: [58, 64], lon: [12, 18], standards: ['ISO27001', 'NIS2'] },
      { name: 'Poland', lat: [50, 54], lon: [18, 22], standards: ['ISO27001', 'NIS2'] },
      { name: 'Russia', lat: [50, 70], lon: [30, 100], standards: ['FSTEC'] },
      { name: 'China', lat: [25, 45], lon: [90, 120], standards: ['MLPS', 'PIPL'] },
      { name: 'Japan', lat: [32, 42], lon: [130, 140], standards: ['ISMS', 'APPI'] },
      { name: 'India', lat: [10, 30], lon: [70, 85], standards: ['CERT-In', 'DPDPA'] },
      { name: 'Pakistan', lat: [25, 35], lon: [65, 75], standards: ['PECA', 'NCSS'] },
      { name: 'Afghanistan', lat: [30, 36], lon: [62, 70], standards: ['Cyber Law'] },
      { name: 'Iran', lat: [28, 38], lon: [50, 60], standards: ['FATA'] },
      { name: 'Australia', lat: [-35, -20], lon: [115, 150], standards: ['ISM', 'Essential8'] },
      { name: 'South Africa', lat: [-32, -25], lon: [20, 30], standards: ['POPIA'] },
      { name: 'Egypt', lat: [25, 30], lon: [28, 32], standards: ['PDPL'] },
      { name: 'Nigeria', lat: [8, 12], lon: [6, 10], standards: ['NDPR'] },
      { name: 'Kenya', lat: [-2, 2], lon: [36, 40], standards: ['DPA'] },
      { name: 'Saudi Arabia', lat: [20, 26], lon: [42, 48], standards: ['ECC', 'NCA'] },
      { name: 'UAE', lat: [22, 25], lon: [53, 56], standards: ['ISR', 'NESA'] },
      { name: 'Turkey', lat: [37, 41], lon: [30, 40], standards: ['KVKK'] },
      { name: 'Singapore', lat: [1, 2], lon: [103, 104], standards: ['PDPA', 'CSA'] },
      { name: 'South Korea', lat: [35, 38], lon: [126, 129], standards: ['ISMS-P'] },
      { name: 'Indonesia', lat: [-5, 0], lon: [105, 120], standards: ['PDP', 'ISO27001'] },
      { name: 'Thailand', lat: [13, 20], lon: [97, 106], standards: ['PDPA'] },
      { name: 'Vietnam', lat: [8, 23], lon: [102, 110], standards: ['Cyber Law'] }
    ];
